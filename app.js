...
function printCV(){
    ...
    document.querySelector('.print-btn-sc').style.display = 'none';
    document.querySelector('.navbar').style.display = 'none';
    
    // Print
    window.print();
    
    // Show the form and other sections again after printing
    document.querySelector('.cv-form').style.display = 'block';
    document.querySelector('.print-btn-sc').style.display = 'block';
